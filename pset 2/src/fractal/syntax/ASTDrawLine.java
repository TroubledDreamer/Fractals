...
*/
public class ASTDrawLine extends ASTStatement {
    // ASTExp srcExp;
    // ASTExp destExp;

  public ASTDrawLine (ASTExp srcExp, ASTExp destExp) {
      super("DRAW SELF", srcExp, destExp);
      // this.srcExp = srcExp;
      // this.destExp = destExp;
  }
  
  public ASTDrawLine(ASTExp destExp) {
      this(null, destExp);
  }
  ...
  public <S, T> T visit(Visitor<S, T> v, S state) throws FractalException {
    return v.visitASTDrawLine(this, state);
  }
